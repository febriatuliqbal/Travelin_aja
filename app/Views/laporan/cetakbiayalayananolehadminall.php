...
<head>
    ...
    <title>LAPORAN BIAYA LAYANAN SEMUA TRAVEL</title>
</head>
    ...
    <table style="width: 100%; border-collapse: collapse; text-align: center;" border="1">
        <tr>
            <td>
                <h1>TRAVELIN AJA</h1>
                <br>
                <h4> DICETAK OLEH ADMIN TRAVELIN AJA</h4>
                </p>
            </td>
        </tr>
        <tr>
            <td>
                <h3 style="height: 1px;"><u>LAPORAN DETAIL BIAYA LAYANAN SEMUA TRAVEL</u></h3>
                <p>
                <p>
