...
<div class="form-row">
    ...
    <div class="form-group col-md-3">
        ...
        <input type="text" class="form-control" placeholder="NO HP KONSUMEN" name="nohp" id="nohp" value="<?= $nohp ?>"
            readonly>
    </div>
    <div class="form-group col-md-4">
        <label for="">HARGA TAMBAHAN PAKET (PER SATUAN)</label>
        <input type="text" class="form-control" placeholder="HARGA TAMBAHAN" name="hargatambahan" id="hargatambahan"
            readonly>
        ...
        <div class="form-row">
            ...
            <div class="form-group col-md-3">
                ...
                <div class="input-group">
                    ...
                    &nbsp;
                    <button style="display: none;" type="button" class="btn btn-sm btn-warning" title="RELOAD DATA"
                        id="tombolreload">
