    ...
    <div class="login-box">
        ...
        <div class="card">
            <div class="card-body login-card-body">
                <p class="login-box-msg">SILAHKAN MASUKAN USER DAN PASWORD ANDA </p>
                ...
                <p class="mb-0">
                    Masuk sebagai <b><a href="login" class="text-center">User Umum</a></b>
                </p>

                <p class="mb-0">
                    Masuk sebagai <b><a href="<?= base_url('login/loginpihaktravel'); ?>"
                            class="text-center">Travel</a></b>
                </p>
