...
<?= $this->section('judul') ?>
<b>MANAJAEMEN DATA PAKET</b>
<?= $this->endSection('judul') ?>

<?= $this->section('subjudul') ?>

<?= form_button('', '<i class="fas fa-plus-square"></i> <b>TAMBAH PAKET</b>', [
  'class' => 'btn btn-success',
  'onclick' => "location.href=('" . site_url('Paket/tambah') . "')"
]) ?>
...
<?= form_open('Paket/index') ?>
<div class="input-group">
  <input type="text" class="form-control form-control-lg" placeholder="CARI DATA PAKET" name="cari" autofocus>
      ...
      <tbody>
        ...
        ?>
          ...
          <tr>
            ...
            <td style="width:20%">
              <center>
                <button type="button" class="btn btn-info" title="EDIT DATA" onclick="edit('<?= $row['kdpaket'] ?>')">
                  <i class="fa fa-edit"></i>
                </button>
                <button type="button" class="btn  btn-danger" onclick="hapus('<?= $row['kdpaket'] ?>')">
