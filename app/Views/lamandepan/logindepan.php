    ...
    <div class="login-box">
        ...
        <div class="card">
            <div class="card-body login-card-body">
                <p class="login-box-msg">SILAHKAN MASUKAN USER DAN PASWORD ANDA UMUM </p>

                <?= form_open('login/cekuserumum'); ?>
                <?= csrf_field(); ?>
                ...
                <p class="mb-0">
                    Belum punya akun <b><a href="<?= base_url('login/daftar') ?>" class="text-center">Daftar
                            disini</a></b>
                </p>
