...
<body>
                        ...
                        <div class="header-top-wrapper">
                            <div class="header-top-info">
                                <div class="email">
                                    ...
                                    <div class="text">
                                        <span>admin@travelinaja.com</span>
                                    </div>
                                </div>
                                <div class="cta">
                                    <div class="icon">
            ...
            <div class="container">
                <div class="d-none d-lg-block">
                    <nav class="menu-area d-flex align-items-center">
                        <div class="logo">
                            <a href="<?= base_url('lamandepan/index') ?>"><img
                                    src="<?= base_url() ?>/depan/dist/images/logo/logo.png" alt="logo" /></a>
                        </div>
                        <ul class="main-menu d-flex align-items-center">
                            <li><a id="home" class="active" href="<?= base_url('lamandepan/index') ?>">Home</a></li>
                            <li><a id="rutetravel" href="<?= base_url('lamandepan/listrute') ?>">Rute Travel</a></li>
                            <li><a id="kontak" href="<?= base_url('lamandepan/pesanansaya') ?>">Pesanan Saya</a></li>
                            <li><a id="profil" href="<?= base_url('lamandepan/profil') ?>">Profil</a></li>
                        ...
                        <div class="menu-icon ml-auto">
                            <ul>
                                ...
                                <li>
                                    Point:
                                    <b>
                                        <br><?= session()->poinpelanggan ?></b>
                                </li>
                                <li>
                                    <a href="<?= base_url('lamandepan/pesanansaya') ?>"><svg
                                ...
                                <li><b><?= session()->namauser ?></b>
                                    <small><?= session()->iduser ?></small></a>
            ...
            <div class="row main-footer">
                <div class="col-lg-4 col-md-12 col-sm-12 col-12">
                    <div class="main-footer-info">
                        <img src="<?= base_url() ?>/depan/dist/images/logo/logo.png" alt="Logo" class="img-fluid">
                        <p>
                            Perjalanan akan tersa indah bila dinikmati
                        </p>
                    </div>
                </div>
                ...
                <div class="col-lg-2 col-md-4 col-sm-6 col-12">
                    <div class="main-footer-quicklinks">
                        ...
                        <ul class="quicklink">
                            ...
                            <li><a href="<?= base_url('login/index') ?>">Login Sebagai ADMIN</a></li>
                            <li><a href="<?= base_url('login/keluarumum') ?>">Log-out</a></li>
                        </ul>
                    </div>
                </div>
            </div>
                ...
                <div class="col-lg-12">
                    <div class="copyright d-flex justify-content-between align-items-center">
                        <div class="copyright-text order-2 order-lg-1">
                            <p>&copy; 2022. Design and Developed by <a href="#">FEBRIATUL IQBAL</a></p>
                        </div>
    ...
    <script src="<?= base_url() ?>/depan/src/js/jquery.min.js"></script>
    <script src="<?= base_url() ?>/depan/src/js/bootstrap.min.js"></script>
    <script src="<?= base_url() ?>/depan/src/scss/vendors/plugin/js/slick.min.js"></script>
    <script src="<?= base_url() ?>/depan/src/scss/vendors/plugin/js/jquery.nice-select.min.js"></script>
    <script src="<?= base_url() ?>/depan/dist/main.js"></script>

    <!-- logo html -->
    <link rel="icon" href="/dist/img/logo.png">


    <link rel="stylesheet" href="<?= base_url() ?>/depan/dist/main.css">
    <link rel="stylesheet" href="<?= base_url() ?>/depan/src/js/jquery.min.css">
    <link rel="stylesheet" href="<?= base_url() ?>/depan/src/js/bootstrap.min.css">
    <link rel="stylesheet" href="<?= base_url() ?>/depan/src/scss/vendors/plugin/js/slick.min.css">
    <link rel="stylesheet" href="<?= base_url() ?>/depan/src/scss/vendors/plugin/js/jquery.nice-select.min.css">
    <link rel="stylesheet" href="<?= base_url() ?>/depan/dist/main.css">
