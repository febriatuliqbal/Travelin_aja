    ...
    <div class="row">
        <div class="col-lg-8 order-2 order-lg-1">
            ...
            <form action="#">
                ...
                <!-- untuk menamilkan jam keberangkatan yang tersedia -->
                <div class="modaljam" style="display: none;"></div>

                <div class="row">

                    <div class="col-lg-8 col-md-4 col-12 mt-30">
                        <div class="form__div">
                    ...
                    <div class="col-lg-4 col-md-4 col-12 mt-30">
                        ...
                        <button id="gunakanpoin" style="height: 50px; color: white; align-items: center;"
                            class="btn  bg-success mt-0" type="">GUNAKAN POIN</button>
                    </div>
                ...
                <div class="row">
                    <div class="col-lg-12 col-md-12 col-12 mt-30">
                        ...
                        <button id="hai" class="btn  bg-primary mt-0" style="width: 100%;" type="submit">PESAN</button>
                    </div>
...
$('#tomboljadwal').click(function(e) {
    e.preventDefault();
    $.ajax({
        url: "/lamandepan/modalDataJam",

        dataType: "json",
        success: function(response) {
            if (response.data) {
                $('.modaljam').html(response.data).show();
                $('#modaldatajam').modal('show');
            }
        }
    });
...
$('#gunakanpoin').click(function(e) {
    e.preventDefault();


    $.ajax({
        type: "post",
        url: "/Lamandepan/gunakanpoin",
        data: {
            total: $('#total').val(),
            idpel: $('#idpel').val(),
        },
