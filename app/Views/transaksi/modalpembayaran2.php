...
<div class="modal fade" id="modalpembayaran" data-backdrop="static" data-keyboard="false" tabindex="-1"
    ...
    <div class="modal-dialog modal-lg ">
        <div class="modal-content">
            ...
            <?= form_open('transaksi/simpanPembayaranDiedit', ['class' => 'frmpembayaran']) ?>
            ...
            <div class="modal-body">
                ...
                <input type="hidden" name="tanggalfaktur" value="<?= $tgl ?>">
                <input type="hidden" name="idpelanggan" value="<?= $idpelanggan ?>">
                <input type="hidden" name="idpaket2" value="<?= $idpaket ?>">
